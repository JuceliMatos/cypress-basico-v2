...
describe('Central de Atendimento ao Cliente TAT', function(){
    ...
    it('campo telefone continu vazio quando preenchido com valor não númerico', function (){ 
    ...
    it('preenche e limpa os campos nome, sobrenome, email e telefone', function(){
        ...
        cy.get('#email').type('maria@exemplo.com').should('have.value', 'maria@exemplo.com').clear().should('have.value', '')
